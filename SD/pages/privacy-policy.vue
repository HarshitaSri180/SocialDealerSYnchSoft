...
<template>
  <div class="card card-body m-5 p-5">
    <h1 class="display-4">Privacy Policy</h1>
    <p class="display-5">Last updated: October 12, 2023</p>
    ...
    <br/>
    <h2 class="display-4">Interpretation and Definitions</h2>
    <br/>
    <h3 class="display-4">Interpretation</h3>
    ...
    <br/>
    <h3 class="display-4">Definitions</h3>
    ...
    <ul>
      ...
      <li>
        <p><strong>Application</strong> refers to Stellar Fate App, the software program provided by the Company.</p>
      </li>
      <li>
        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or
          &quot;Our&quot; in this Agreement) refers to Synch Soft Technologies Private Limited, Vibhuti Khand, Lucknow .
        </p>
      </li>
      <li>
      ...
      <li>
        <p><strong>Website</strong> refers to Stellar Fate, accessible from <a href="https://www.stellarfate.com/"
                                                                               rel="external nofollow noopener"
                                                                               target="_blank">https://www.stellarfate.com/</a>
        </p>
      </li>
      <li>
    ...
    <br/>
    <h3 class="display-4">Types of Data Collected</h3>
    <h4>Personal Data</h4>
    ...
    <br/>
    <h3 class="display-4">Use of Your Personal Data</h3>
    ...
    <br/>
    <h3 class="display-4">Retention of Your Personal Data</h3>
    ...
    <br/>
    <h3 class="display-4">Transfer of Your Personal Data</h3>
    ...
    <p>The Company will take all steps reasonably necessary to ensure that Your data is treated securely and in
      ...
      information.</p>
    <br/>
    <h3 class="display-4">Delete Your Personal Data</h3>
    ...
    <p>Please note, however, that We may need to retain certain information when we have a legal obligation or lawful
      basis to do so.</p>
    <br/>
    <h3 class="display-4">Disclosure of Your Personal Data</h3>
    ...
    <br/>
    <h3 class="display-4">Security of Your Personal Data</h3>
    ...
    <ul>
      <li>
        <p>By email: support@stellarfate.com</p>
      </li>
      <li>
        <p>By visiting this page on our website: <a href="https://www.stellarfate.com/support"
                                                    rel="external nofollow noopener" target="_blank">https://www.stellarfate.com/support</a>
        </p>
      </li>
    </ul>
  </div>
